...
module.exports = function(options) {
    return {
        ...
        to: options.email,
        subject: "Ваши данные для доступа в систему RQ view были изменены",
        html: `
                                                    ...
                                                    <table class="title" style="border-collapse:collapse;">
                                                        <tr>
                                                            <td style="padding-bottom:26px;">
                                                                <h1 style="font-family:'Arial'; font-size:24px; line-height:27px; color:#2E2382; margin:0;">Изменение данных для доступа в систему RQ view.</h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding-top:0px;">
                                                    <table class="text-unit" style="border-collapse:collapse;">
                                                        <tr>
                                                            <td style="padding-top:0px; padding-bottom:22px; font-weight: 500; font-size: 14px; line-height: 24px; color: #505D6F;">Ваши данные для доступа в систему RQ view были изменены.</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td style="font-family:'Arial'; font-weight:500; font-size:14px; line-height:24px; color:#505D6F;  padding-bottom:28px;">
                                                                <table style="border-collapse:collapse;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="font-size:14px; line-height:24px; font-weight:500; color:#505D6F;">Новый пароль: <span style="color:#2E2382;">${options.password}</span></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
