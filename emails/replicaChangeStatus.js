...
module.exports = function(options) {
    ...
    return {
        ...
        to: options.email,
        subject: "Статус реплики изменен",
        html: `
                                        ...
                                        <table class="wrap" style="width:100%; width:100%; border-collapse:collapse;">
                                            <tr>
                                                <td style="background:#fff; height:99px; padding-left:40px;">
                                                    <a style="display:inline-block;" href="https://amdg.ru/" target="_blank">
                                                    ...
                                                    <table class="title" style="border-collapse:collapse;">
                                                        <tr>
                                                            <td style="padding-bottom:26px;">
                                                                <h1 style="font-family:'Arial'; font-size:24px; line-height:27px; color:#2E2382; margin:0;">Статус реплики изменен</h1>
                                                            </td>
                                                        </tr>
                                                    </table>
