...
module.exports = function(options) {
    return {
        ...
        to: options.email,
        subject: "Вы исключены из проекта в системе RQ view",
        html: `
                                        ...
                                        <table class="wrap" style="background:#F7F9FE; width:100%; border-collapse:collapse; width:100%;">
                                            <tr>
                                                ...
                                                <td style="padding-top:38px;">
                                                    ...
                                                    <table class="title" style="border-collapse:collapse;">
                                                        <tr>
                                                            <td style="padding-bottom:26px;">
                                                                <h1 style="font-family:'Arial'; font-size:24px; line-height:27px; color:#2E2382; margin:0;">Вы исключены из проекта в системе RQ view</h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table class="text-unit" style="border-collapse:collapse;">
                                                        <tr>
                                                            <td style="padding-bottom:6px; font-weight: 500; font-size: 12px; line-height: 15px; color: #94A2B6;">Роль</td>
                                                        </tr>
                                                
                                                        <tr>
                                                            <td style="font-family:'Arial'; font-weight:500; font-size:18px; line-height:22px; color:#2E2382;  padding-bottom:30px;">${options.role}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table class="wrap" style="background:#ffffff; width:100%; border-collapse:collapse; width:100%;">
                                            <tr>
                                                ...
                                                <td style="padding-top:27px;">
                                                    <table class="text-unit" style="border-collapse:collapse;">
                                                        <tr>
                                                            <td style="padding-top:33px; padding-bottom:22px; font-weight: 500; font-size: 14px; line-height: 24px; color: #505D6F;">По вопросам, связанным с причиной исключения — обратитесь к Администратору.</td>
                                                        </tr>
                                                    </table>
                                                </td>
